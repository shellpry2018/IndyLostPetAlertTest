...
function mh_customize_register($wp_customize) {
    ...
    $wp_customize->add_setting('mh_options[ticker_title]', array('default' => 'News Ticker', 'type' => 'option', 'sanitize_callback' => 'mh_sanitize_text'));
	...
	$wp_customize->add_setting('mh_options[post_meta_header]', array('default' => '', 'type' => 'option'));
    ...
    $wp_customize->add_setting('mh_options[color_bg_header]', array('default' => '#ffffff', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_bg_inner]', array('default' => '#ffffff', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_1]', array('default' => '#2a2a2a', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_2]', array('default' => '#e64946', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_text_general]', array('default' => '#000000', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_text_1]', array('default' => '#ffffff', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_text_2]', array('default' => '#ffffff', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_text_meta]', array('default' => '#979797', 'type' => 'option'));
    $wp_customize->add_setting('mh_options[color_links', array('default' => '#000000', 'type' => 'option'));
	$wp_customize->add_setting('mh_options[color_links_hover', array('default' => '#e64946', 'type' => 'option'));
    ...
    $wp_customize->add_control('wt_layout', array('label' => __('Widget Titles', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[wt_layout]', 'priority' => 1, 'type' => 'select', 'choices' => array('layout1' => sprintf(_x('Layout %d', 'options panel', 'mh'), 1), 'layout2' => sprintf(_x('Layout %d', 'options panel', 'mh'), 2), 'layout3' => sprintf(_x('Layout %d', 'options panel', 'mh'), 3))));
    $wp_customize->add_control('page_title_layout', array('label' => __('Page Titles', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[page_title_layout]', 'priority' => 2, 'type' => 'select', 'choices' => array('layout1' => sprintf(_x('Layout %d', 'options panel', 'mh'), 1), 'layout2' => sprintf(_x('Layout %d', 'options panel', 'mh'), 2))));
    $wp_customize->add_control('authorbox_layout', array('label' => __('Author Box', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[authorbox_layout]', 'priority' => 3, 'type' => 'select', 'choices' => array('layout1' => sprintf(_x('Layout %d', 'options panel', 'mh'), 1), 'layout2' => sprintf(_x('Layout %d', 'options panel', 'mh'), 2), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('author_contact', array('label' => __('Author Box Contact', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[author_contact]', 'priority' => 4, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('related_layout', array('label' => __('Related Articles', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[related_layout]', 'priority' => 5, 'type' => 'select', 'choices' => array('layout1' => sprintf(_x('Layout %d', 'options panel', 'mh'), 1), 'layout2' => sprintf(_x('Layout %d', 'options panel', 'mh'), 2), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('loop_layout', array('label' => __('Archives', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[loop_layout]', 'priority' => 6, 'type' => 'select', 'choices' => array('layout1' => sprintf(_x('Layout %d', 'options panel', 'mh'), 1), 'layout2' => sprintf(_x('Layout %d', 'options panel', 'mh'), 2), 'layout3' => sprintf(_x('Layout %d', 'options panel', 'mh'), 3))));
    $wp_customize->add_control('sidebars', array('label' => __('Sidebars', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[sidebars]', 'priority' => 7, 'type' => 'select', 'choices' => array('one' => __('One Sidebar', 'mh'), 'two' => __('Two Sidebars', 'mh'), 'no' => __('No Sidebars', 'mh'))));
    $wp_customize->add_control('sb_position', array('label' => __('Position of default Sidebar', 'mh'), 'section' => 'mh_layout', 'settings' => 'mh_options[sb_position]', 'priority' => 8, 'type' => 'select', 'choices' => array('left' => __('Left', 'mh'), 'right' => __('Right', 'mh'))));
    ...
    $wp_customize->add_control('google_webfonts', array('label' => __('Google Webfonts', 'mh'), 'section' => 'mh_typo', 'settings' => 'mh_options[google_webfonts]', 'priority' => 2, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
	$wp_customize->add_control('google_webfonts_subsets', array('label' => __('Google Webfonts Characters', 'mh'), 'section' => 'mh_typo', 'settings' => 'mh_options[google_webfonts_subsets]', 'priority' => 3, 'type' => 'select', 'choices' => array('latin' => __('Latin', 'mh'), 'latin_ext' => __('Latin Extended', 'mh'), 'greek' => __('Greek', 'mh'), 'greek_ext' => __('Greek Extended', 'mh'), 'cyrillic' => __('Cyrillic', 'mh'), 'cyrillic_ext' => __('Cyrillic Extended', 'mh'))));
	$wp_customize->add_control('font_heading', array('label' => __('Google Webfont for Headings', 'mh'), 'section' => 'mh_typo', 'settings' => 'mh_options[font_heading]', 'priority' => 4, 'type' => 'select', 'choices' => $google_fonts));
	$wp_customize->add_control('font_body', array('label' => __('Google Webfont for Body Text', 'mh'), 'section' => 'mh_typo', 'settings' => 'mh_options[font_body]', 'priority' => 5, 'type' => 'select', 'choices' => $google_fonts));
	$wp_customize->add_control('font_styles', array('label' => __('Imported Google Font Styles', 'mh'), 'section' => 'mh_typo', 'settings' => 'mh_options[font_styles]', 'priority' => 6, 'type' => 'text'));
    ...
    $wp_customize->add_control('ticker_offset', array('label' => __('Skip Posts (Offset):', 'mh'), 'section' => 'mh_ticker', 'settings' => 'mh_options[ticker_offset]', 'priority' => 6, 'type' => 'text'));
	...
	$wp_customize->add_control('breadcrumbs', array('label' => __('Breadcrumb Navigation', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[breadcrumbs]', 'priority' => 1, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('teaser_text', array('label' => __('Teaser Text on Posts', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[teaser_text]', 'priority' => 2, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('featured_image', array('label' => __('Featured Image on Posts', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[featured_image]', 'priority' => 3, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('link_featured_image', array('label' => __('Link Featured Image to Attachment', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[link_featured_image]', 'priority' => 4, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('comments_pages', array('label' => __('Comments on Pages', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[comments_pages]', 'priority' => 5, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('post_nav', array('label' => __('Post/Attachment Navigation', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_nav]', 'priority' => 6, 'type' => 'select', 'choices' => array('enable' => __('Enable', 'mh'), 'disable' => __('Disable', 'mh'))));
    $wp_customize->add_control('social_buttons', array('label' => __('Social Buttons on Posts', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[social_buttons]', 'priority' => 7, 'type' => 'select', 'choices' => array('both_social' => __('Top and bottom', 'mh'), 'top_social' => __('Top of posts', 'mh'), 'bottom_social' => __('Bottom of posts', 'mh'), 'disable' => __('Disable', 'mh'))));
	$wp_customize->add_control(new MH_Customize_Header_Control($wp_customize, 'post_meta_header', array('label' => __('Disable Post Meta Data', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_meta_header]', 'priority' => 8)));
    $wp_customize->add_control('post_meta_date', array('label' => __('Disable Date', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_meta_date]', 'priority' => 9, 'type' => 'checkbox'));
    $wp_customize->add_control('post_meta_author', array('label' => __('Disable Author', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_meta_author]', 'priority' => 10, 'type' => 'checkbox'));
    $wp_customize->add_control('post_meta_cat', array('label' => __('Disable Categories', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_meta_cat]', 'priority' => 11, 'type' => 'checkbox'));
    $wp_customize->add_control('post_meta_comments', array('label' => __('Disable Comments', 'mh'), 'section' => 'mh_content', 'settings' => 'mh_options[post_meta_comments]', 'priority' => 12, 'type' => 'checkbox'));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_1', array('label' => sprintf(_x('Theme Color %d', 'options panel', 'mh'), 1), 'section' => 'colors', 'settings' => 'mh_options[color_1]', 'priority' => 52)));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_2', array('label' => sprintf(_x('Theme Color %d', 'options panel', 'mh'), 2), 'section' => 'colors', 'settings' => 'mh_options[color_2]', 'priority' => 53)));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_text_general', array('label' => __('Text: General', 'mh'), 'section' => 'colors', 'settings' => 'mh_options[color_text_general]', 'priority' => 54)));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_text_1', array('label' => sprintf(_x('Text: Colored Sections (Color %d)', 'options panel', 'mh'), 1), 'section' => 'colors', 'settings' => 'mh_options[color_text_1]', 'priority' => 55)));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_text_2', array('label' => sprintf(_x('Text: Colored Sections (Color %d)', 'options panel', 'mh'), 2), 'section' => 'colors', 'settings' => 'mh_options[color_text_2]', 'priority' => 56)));
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_links', array('label' => __('Links: General Color', 'mh'), 'section' => 'colors', 'settings' => 'mh_options[color_links]', 'priority' => 58)));
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'color_links_hover', array('label' => __('Links: Hover Color', 'mh'), 'section' => 'colors', 'settings' => 'mh_options[color_links_hover]', 'priority' => 59)));
