...
class mh_custom_slider_widget extends WP_Widget {
    function mh_custom_slider_widget() {
        $widget_ops = array('classname' => 'mh_custom_slider', 'description' => __('Custom Slider Widget to display custom content for use on homepage template.', 'mh'));
        $this->WP_Widget('mh_custom_slider', __('MH Custom Slider Widget', 'mh'), $widget_ops);
    }
    ...
    function update($new_instance, $old_instance) {
		...
		$instance['target1'] = strip_tags($new_instance['target1']);
		...
		$instance['target2'] = strip_tags($new_instance['target2']);
		...
		$instance['target3'] = strip_tags($new_instance['target3']);
		...
		$instance['target4'] = strip_tags($new_instance['target4']);
		...
		$instance['target5'] = strip_tags($new_instance['target5']);
