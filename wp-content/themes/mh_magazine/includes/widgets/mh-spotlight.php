...
class mh_spotlight_hp_widget extends WP_Widget {
    function mh_spotlight_hp_widget() {
        $widget_ops = array('classname' => 'mh_spotlight_hp', 'description' => __('Spotlight / Featured widget for use on homepage template.', 'mh'));
    ...
    function form($instance) {
        $defaults = array('title' => '', 'category' => '', 'tags' => '', 'offset' => '0', 'order' => 'date', 'width' => 'normal_sl', 'excerpt_length' => '175', 'excerpt' => 0, 'meta' => 0, 'comments' => 0);
