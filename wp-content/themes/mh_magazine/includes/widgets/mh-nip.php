...
class mh_nip_widget extends WP_Widget {
    function mh_nip_widget() {
        $widget_ops = array('classname' => 'mh_nip', 'description' => __('News in Pictures Widget to display a gallery of thumbnails linked to the post content.', 'mh'));
        $this->WP_Widget('mh_nip', __('MH News in Pictures', 'mh'), $widget_ops);
    }
    ...
    function form($instance) {
        $defaults = array('title' => '', 'category' => '', 'cats' => '', 'tags' => '', 'postcount' => '9', 'offset' => '0', 'order' => 'date', 'sticky' => 0);
