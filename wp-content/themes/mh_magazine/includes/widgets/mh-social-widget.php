...
class mh_social_widget extends WP_Widget {
	function mh_social_widget() {
        $widget_ops = array('classname' => 'mh_social_widget', 'description' => __('Widget to display linked social media icons in sidebar or footer.', 'mh'));
        $this->WP_Widget('mh_social_widget', __('MH Social Widget', 'mh'), $widget_ops);
    }
