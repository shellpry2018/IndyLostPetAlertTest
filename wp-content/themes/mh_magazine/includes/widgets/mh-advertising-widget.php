...
class mh_advertising_widget extends WP_Widget {
    function mh_advertising_widget() {
        $widget_ops = array('classname' => 'mh_advertising', 'description' => __('MH Advertising Widget to display ads in widget locations of your choice.', 'mh'));
        $this->WP_Widget('mh_advertising', __('MH Advertising Widget', 'mh'), $widget_ops);
    }
    ...
    function update($new_instance, $old_instance) {
        ...
        $instance['mh_adtype'] = $new_instance['mh_adtype'];
